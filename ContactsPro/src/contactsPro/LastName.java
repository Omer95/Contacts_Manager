...
Node RootLastName; // For last name. 
Node SearchValue;
...
public void Insert(String Name, ContactDetails CD){
    ...
    RootLastName = DoInsertLast(RootLastName, Name,t, CD); 

}    
    
public Node DoInsertLast (Node rootN, String Name, int strV, ContactDetails CD){ //Last Name
...
char c; 
    ...
    if(rootN == null){
        ...
        if(c == 'a'){
            ...
            rootN.a.alphabet = c;        
         temp = rootN.a; 
         temp= DoInsertLast(temp, Name, strV, CD); // the return variable temp is not needed. Will remove it later. Let it be. 
        }
        else if(c == 'b'){
            rootN.b = new Node();
            rootN.b.alphabet = c;        
         temp = rootN.b; 
         temp = DoInsertLast(temp, Name, strV, CD);
        }
        else if(c == 'c'){
            rootN.c = new Node();
            rootN.c.alphabet = c;        
...
temp = ToSearch(RootLastName, name, t);
...
public Node ToSearch(Node rootN, String name, int strV ){
    ...
    strV++;
        ...
        if(rootN.end == true){
             ...
             }             SearchValue = rootN; //this is for the delete function. 
        }
        else{
...
ToSearch(RootLastName, name, 0); //First Searches for the name. 
...
public void DisplayLastName(){
    ToDisplayLastName(RootLastName);
}
